...
R package **piktests**, version **0.8.8**
...
Führlich P, Dietrich J (2022). _piktests: Run PIK Integration Tests_. R package version 0.8.8, <URL: https://github.com/pik-piam/piktests>.
